...
def build_gaussian_policy_graph(observation_placeholder: tf.Tensor, experiment_spec: ExperimentSpec,
    ...
    with tf.name_scope(vocab.actor_network) as scope:
        ...
        # ::Continuous case
            ...
            sampled_action_logLikelihood = policy_distribution.log_prob(sampled_action,
                                                                        name=vocab.sampled_action_logLikelihood)
...
def apply_action_bound(sampled_action: tf_cv1.Tensor, sampled_action_logLikelihood: tf_cv1.Tensor) -> Tuple[
    tf_cv1.Tensor, ...]:
    """
...
def critic_train(advantage, experiment_spec: ExperimentSpec) -> Tuple[tf_cv1.Tensor, tf_cv1.Operation]:
    """
    Critic loss
    ...
    #     # critic_optimizer = tf_cv1.train.AdamOptimizer(learning_rate=experiment_spec[
    #     'critic_learning_rate']).minimize(critic_loss, name=vocab.critic_optimizer)
    # return critic_loss, critic_optimizer
