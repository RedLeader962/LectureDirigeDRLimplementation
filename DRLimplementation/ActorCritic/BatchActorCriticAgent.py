...
class BatchActorCriticAgent(Agent):
    ...
    def _build_computation_graph(self):
        ...
        self.summary_trj_lenght_op = tf_cv1.summary.scalar('Trajectory lenght', self.Summary_trj_lenght_ph, family=vocab.Trajectory_lenght)
                    ...
                    while True:
                        ...
                        if done:
                            ...
                            consol_print_learning_stats.trajectory_training_stat(
                                the_trajectory_return=trj_return, timestep=trj_len)
                            break
