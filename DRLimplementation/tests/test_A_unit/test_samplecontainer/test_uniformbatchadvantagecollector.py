...
def test_UniformBatchCollector_INIT(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
    uni_batch_collector: UniformBatchCollectorBatchAdvantage
    env: Union[TimeLimit, Any]
    # endregion
    
    exp_spec, playground, trajectory_collector, uni_batch_collector, env, _ = gym_discrete_batch_advantage_setup
...
def test_UniformBatchCollector_ONE_STEP(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
...
def test_UniformBatchCollector_20_STEP_OVER_2_TRJ(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
...
def test_UniformBatchCollector_AT_BATCH_CAPACITY(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
    ...
    uni_batch_collector = UniformBatchCollectorBatchAdvantage(capacity=200)
    exp_spec, playground, trajectory_collector, _, env, _ = gym_discrete_batch_advantage_setup
...
def test_UniformBatchCollector_AT_BATCH_CAPACITY_MINUS_ONE(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
...
def test_UniformBatchCollector_OVER_CAPACITY(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
...
def test_UniformBatchCollector_TWO_BATCHS(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
...
def test_UniformBatchCollector_CUT_TRAJECTORY(gym_discrete_batch_advantage_setup):
    # region ::Type hint bloc ...
    exp_spec: ExperimentSpec
    playground: GymPlayground
    trajectory_collector: TrajectoryCollectorBatchAdvantage
