...
def init_spec_and_agent(hparam):
...
def setup_train_algo_generator_with_PASSING_spec():
    ...
    epoch_generator, exp_spec, consol_print_learning_stats = init_spec_and_agent(hparam=CARTPOLE_HPARAM)
...
def setup_train_algo_generator_with_FAILING_spec():
    ...
    epoch_generator, exp_spec, consol_print_learning_stats = init_spec_and_agent(hparam=CARTPOLE_HPARAM_FAIL)
    yield epoch_generator, nb_of_try, env_max_return, exp_spec
    consol_print_learning_stats.print_experiment_stats(print_plot=not exp_spec.isTestRun)
...
def test_integration_REINFORCEagent_train_PASS(setup_train_algo_generator_with_PASSING_spec):
    epoch_generator, nb_of_try, env_max_return, exp_spec = setup_train_algo_generator_with_PASSING_spec
...
def test_integration_REINFORCEagent_train_ALL_RUN_DIFFERENT(setup_train_algo_generator_with_PASSING_spec):
    epoch_generator, nb_of_try, env_max_return, exp_spec = setup_train_algo_generator_with_PASSING_spec
