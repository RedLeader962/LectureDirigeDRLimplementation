...
class REINFORCEagent(object):
    ...
    def _training_epoch_generator(self, consol_print_learning_stats: ConsolPrintLearningStats, render_env: bool):
        ...
        """ ---- Optimizer ---- """
        policy_optimizer_op = bloc.policy_optimizer(self.pseudo_loss, self.exp_spec.learning_rate)
        ...
        with tf_cv1.Session() as sess:
            ...
            for epoch in range(self.exp_spec.max_epoch):
                ...
                epoch_loss, _ = sess.run([self.pseudo_loss, policy_optimizer_op],
                ...
                # expose epoch computed information for integration test
                yield (epoch, epoch_loss, batch_average_trjs_return, batch_average_trjs_lenght)
        ...
        with tf_cv1.Session() as sess:
            ...
            for run in range(max_trajectories):
                ...
                while True:
                    ...
                    action_array = sess.run(self.policy_action_sampler, feed_dict={self.observation_ph: step_observation})
